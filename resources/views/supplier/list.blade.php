    ...
    <div class="p-2 overflow-x-auto bg-white shadow-md sm:rounded-lg">
        <div class="flex items-center justify-end mt-2 mb-4 mr-5">
            <button type="button" class="flex items-center justify-center">
                <a href="{{ route('supplier.create') }}" class="flex items-center justify-center gap-2 px-3 py-2 font-sans text-white bg-blue-600 rounded-md cursor-pointer text-md hover:bg-blue-800">
                    ...
                    @foreach ($supplier as $key => $data)
                        <tr class="even:bg-gray-50">
                            ...
                            <td class="flex items-center gap-4 px-6 py-4">
                                <a href="{{ route('product.edit',$data->id)}}" class="font-medium">
                                ...
                                <form action="{{ route('product.delete', $data->id) }}" method="POST" class="flex items-center justify-center" >
                                    @csrf
                                    @method('DELETE')
