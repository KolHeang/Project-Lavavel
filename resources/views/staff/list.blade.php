...
<div class="flex flex-col w-full h-full"> 
    <div class="p-2 overflow-x-auto bg-white shadow-md sm:rounded-lg">
        <div class="flex items-center justify-end mt-4 mb-4 mr-10">
            <a href="/employee/create" class="flex items-center justify-center w-20 p-1 font-sans text-lg text-white bg-blue-500 rounded-md shadow-md hover:bg-blue-700">Add</a>
        </div>
