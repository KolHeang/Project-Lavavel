...
<body>
    <div>
        <aside class="fixed h-screen bg-slate-800 shadow-md w-64 left-0 top-0 z-40">
            <div class="h-full">
                <div class="flex h-20 w-full items-center justify-center border-b-2 text-white text-lg">
                    <h1>Hello Heang</h1>
                </div>
                <div class="flex h-full p-4 w-full">
        ...
        <div class="sm:ml-64 bg-gray-100 h-screen">
            <nav class="flex w-full h-20 bg-white shadow-md border-l-2">

            </nav>

            <main class="flex w-full p-4">
                <div class="flex w-full h-[830px]">Hello</div>
            </main>
        </div>
    </div>
</body>
